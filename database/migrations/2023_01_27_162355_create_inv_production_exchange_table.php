...
class CreateInvProductionExchangeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inv_production_exchange', function (Blueprint $table) {
            $table->id();
            $table->tinyInteger('order_type')->nullable();
            $table->bigInteger('auto_serial')->nullable();
            $table->bigInteger('inv_production_order_auto_serial')->nullable();
    ...
    {
        Schema::dropIfExists('inv_production_exchange');
    }
}
