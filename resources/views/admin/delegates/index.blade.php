...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                    <input type="radio" checked name="searchbyradio" id="searchbyradio" value="delegate_code"> برقم
                    المندوب
                    ...
                    <input autofocus style="margin-top: 6px !important;" type="text" id="search_by_text"
                        placeholder=" اسم  - رقم الحساب  - كود المندوب" class="form-control"> <br>
                        ...
                        <tbody>
                            @foreach ($data as $info)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.delegates.edit', $info->id) }}"
                                            class="btn btn-sm  btn-primary">تعديل</a>
                                        <button data-id="{{ $info->id }}"
                                            class="btn btn-sm show_more_details  btn-info">المزيد</button>
