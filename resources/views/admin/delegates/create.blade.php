                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="percent_type" id="percent_type" class="form-control">
                                <option value="">اختر الحالة</option>
                                <option @if (old('percent_type') == 1) selected="selected" @endif value="1"> اجر
                                    ثابت</option>
                                <option @if (old('percent_type') == 0 and old('percent_type') != '') selected="selected" @endif value="2"> نسبة
                                </option>
                            </select>
                            @error('percent_type')
                                <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="percent_collect_commission" id="percent_collect_commission" class="form-control"
                                oninput="this.value=this.value.replace(/[^0-9.]/g,'');" value="{{ old('start_balance') }}">
