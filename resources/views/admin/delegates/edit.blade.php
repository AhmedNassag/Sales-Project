                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="percent_salaes_commission_kataei" id="percent_salaes_commission_kataei" class="form-control" oninput="this.value=this.value.replace(/[^0-9.]/g,'');" value="{{ old('percent_salaes_commission_kataei', $data['percent_salaes_commission_kataei'] * 1) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="percent_salaes_commission_nosjomla" id="percent_salaes_commission_nosjomla" class="form-control" oninput="this.value=this.value.replace(/[^0-9.]/g,'');" value="{{ old('percent_salaes_commission_nosjomla', $data['percent_salaes_commission_nosjomla'] * 1) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="percent_salaes_commission_jomla" id="percent_salaes_commission_jomla" class="form-control" oninput="this.value=this.value.replace(/[^0-9.]/g,'');" value="{{ old('percent_salaes_commission_jomla', $data['percent_salaes_commission_jomla'] * 1) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="percent_collect_commission" id="percent_collect_commission" class="form-control" oninput="this.value=this.value.replace(/[^0-9.]/g,'');" value="{{ old('percent_collect_commission', $data['percent_collect_commission'] * 1) }}">
