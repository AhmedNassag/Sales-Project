                    ...
                    <form action="{{ route('admin.Services.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" id="name" class="form-control" value="{{ old('name') }}"
                                placeholder="ادخل اسم الخدمة" oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')"
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control">
                                ...
                                <option @if (old('type') == 1) selected="selected" @endif value="1"> خدمات
                                    مقدمة لنا</option>
                                <option @if (old('type') == 2 and old('type') != '') selected="selected" @endif value="2"> خدمات
                                    نقدمها للغير </option>
                            </select>
                            @error('type')
                                <span class="text-danger">{{ $message }}</span>
