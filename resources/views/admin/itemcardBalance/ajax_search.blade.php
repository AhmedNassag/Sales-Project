                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @foreach ($info->allBathces as $Det)
                                        <tr>
                                            <td @if ($Det->quantity == 0) class="bg-danger" @endif>
                                                {{ $Det->auto_serial }}</td>
                                            <td>{{ $Det->store_name }}</td>
                                            <td>
                                                عدد ( {{ $Det->quantity * 1 }} ) {{ $info->Uom_name }} بإجمالي تكلفة (
                                                ...
                                                @if ($info->does_has_retailunit == 1)
                                                    ...
                                                    <br>
                                                    عدد ( {{ $Det->qunatityRetail * 1 }} ) {{ $info->retail_uom_name }}
                                                    بإجمالي تكلفة ({{ $Det->total_cost_price * 1 }} جنيه) <br>
