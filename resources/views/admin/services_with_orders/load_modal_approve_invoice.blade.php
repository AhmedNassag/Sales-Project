                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input readonly oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="total_cost_items" id="total_cost_items" class="form-control" value="{{ $data['total_cost_items'] * 1 }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label> نسبة ضريبة القيمة المضافة </label>
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="tax_percent" id="tax_percent" class="form-control" value="{{ $data['tax_percent'] * 1 }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input readonly id="total_befor_discount" name="total_befor_discount" class="form-control" value="{{ $data['total_befor_discount'] * 1 }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
