                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($info->is_approved == 0)
                                                    <a href="{{ route('admin.Services_orders.edit', $info->id) }}"
                                                        class="btn btn-sm  btn-success">تعديل</a>
                                                    <a href="{{ route('admin.Services_orders.delete', $info->id) }}"
                                                        class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                                                @endif
                                                <a href="{{ route('admin.Services_orders.show', $info->id) }}"
                                                    class="btn btn-sm   btn-info">التفاصيل</a>
                                                <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white"
                                                    target="_blank"
                                                    href="{{ route('admin.Services_orders.printsaleswina4', [$info->id, 'A4']) }}"
                                                    class="btn btn-primary btn-xs"> WA4</a>
                                                <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white"
                                                    target="_blank"
                                                    href="{{ route('admin.Services_orders.printsaleswina4', [$info->id, 'A6']) }}"
