    ...
    <table cellspacing="0" style="width: 30%; margin-right: 5px; float: right;  border: 1px dashed black " dir="rtl">
        ...
        <tr>
            <td style="padding: 5px; text-align: right;font-weight: bold;"> نوع الفاتورة
                <span style="margin-right: 10px;">/ @if ($data['order_type'] == 1)
                        خدمات مقدمة لنا
                    @else
                        خدمات نقدمها للغير
                    @endif
        ...
        @if ($data['is_account_number'] == 1)
            ...
            <tr>
                <td style="padding: 5px; text-align: right;font-weight: bold;"> اسم الحساب المالي <span
                        style="margin-right: 10px;">/ {{ $data['account_name'] }}</span></td>
            </tr>
        @else
            <tr>
                <td style="padding: 5px; text-align: right;font-weight: bold;"> اسم الجهة الخارجية <span
                        style="margin-right: 10px;">/ {{ $data['entity_name'] }}</span></td>
            </tr>
        @endif
