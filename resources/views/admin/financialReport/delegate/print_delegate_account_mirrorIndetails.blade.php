...
<body style="padding-top: 10px;font-family: tahoma;">
    ...
    <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> المبيعات طرف المندوب خلال الفترة
    </h3>
    ...
    <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> حركة الخدمات الداخلية والخارجية
        علي حساب المورد للمندوب الفترة</h3>
    ...
    <!--  حركة النقدية-->
    <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> حركة النقدية علي حساب المندوب
        خلال الفترة</h3>
