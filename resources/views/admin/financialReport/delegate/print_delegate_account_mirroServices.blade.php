...
<body style="padding-top: 10px;font-family: tahoma;">
    ...
    @if ($data['Does_show_items'] == 1)
        <!--  حركة الخدمات-->
        <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> حركة الخدمات الداخلية
            والخارجية علي حساب للمندوب خلال الفترة</h3>
    ...
    @else
        <!--  حركة الخدمات-->
        <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> حركة الخدمات الداخلية
            والخارجية علي حساب المورد للمندوب الفترة</h3>
        @if (@isset($details['services_orders']) &&
            !@empty($details['services_orders']) &&
            count($details['services_orders']) > 0)
            <table dir="rtl" id="example2" class="table table-bordered table-hover"
