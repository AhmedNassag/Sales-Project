...
<body style="padding-top: 10px;font-family: tahoma;">
    ...
    <table dir="rtl" border="1" style="width: 98%; margin: 0 auto;" id="example2" cellpadding="1"
        ...
        <tr>
            ...
            <td style="width: 75%;text-align: right; padding-right: 5px; ">
                عدد ({{ $data['BurchaseReturnCounter'] * 1 }}) فاتورة مرتجع مشتريات بقيمة
                ({{ $data['BurchaseReturnTotalMoney'] * 1 }}) جنيه
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 75%;text-align: right; padding-right: 5px; ">
                عدد ({{ $data['ServicesForotherCounter'] * 1 }}) فاتورة خدمات قدمناها للمورد بقيمة
    ...
    <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> المشتريات من المورد خلال الفترة
    </h3>
    ...
    @endif
    <!--  مرتجع المشتريات-->
    <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> مرتجع المشتريات من المورد خلال
        الفترة</h3>
    @if (@isset($details['BurchasesReturn']) &&
        !@empty($details['BurchasesReturn']) &&
        count($details['BurchasesReturn']) > 0)
        <table dir="rtl" id="example2" class="table table-bordered table-hover"
            style="width: 99%;margin: 0 auto;">
            <thead style="background-color: lightgrey">
                <th>رقم الفاتورة</th>
    ...
    @endif
    <!--  حركة النقدية-->
    <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> حركة النقدية علي حساب المورد
        خلال الفترة</h3>
    ...
    <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> حركة الخدمات الداخلية والخارجية
        علي حساب المورد خلال الفترة</h3>
