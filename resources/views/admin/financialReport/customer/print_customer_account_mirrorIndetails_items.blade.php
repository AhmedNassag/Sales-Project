...
<body style="padding-top: 10px;font-family: tahoma;">
    ...
    <table dir="rtl" border="1" style="width: 98%; margin: 0 auto;" id="example2" cellpadding="1"
        ...
        <tr>
            ...
            <td style="width: 75%;text-align: right; padding-right: 5px; ">
                عدد ({{ $data['SalesReturnCounter'] * 1 }}) فاتورة مرتجع مبيعات بقيمة
                ({{ $data['salesReturnTotalMoney'] * 1 }}) جنيه
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width: 75%;text-align: right; padding-right: 5px; ">
                عدد ({{ $data['ServicesForotherCounter'] * 1 }}) فاتورة خدمات قدمناها للعميل بقيمة
    ...
    @endif
    <!--  مرتجع المبيعات-->
    <h3 style="font-size: 16px; text-align: center; margin-top: 5px;font-weight: bold"> مرتجع المبيعات للعميل خلال
        الفترة</h3>
