...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4">
                    <input type="radio" checked name="searchbyradio" id="searchbyradio" value="production_lines_code">
                    برقم الخط
                    ...
                    <input autofocus style="margin-top: 6px !important;" type="text" id="search_by_text"
                        placeholder=" اسم  - رقم الحساب  - كود الخط" class="form-control"> <br>
                            ...
                            @foreach ($data as $info)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.inv_production_lines.edit', $info->id) }}"
...
@section('script')
    <script src="{{ asset('admin/js/inv_production_lines.js') }}"></script>
@endsection
