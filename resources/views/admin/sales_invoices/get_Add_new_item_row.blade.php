<tr>
    ...
    <td class="text-center">{{ $received_data['sales_item_type_name'] }}</td>
    <td class="text-center">{{ $received_data['item_code_name'] }}</td>
    <td class="text-center">{{ $received_data['uom_id_name'] }}</td>
    <td class="text-center">{{ $received_data['item_price'] * 1 }}</td>
    <td class="text-center">{{ $received_data['item_quantity'] * 1 }}</td>
    <td class="text-center">{{ $received_data['item_total'] * 1 }}</td>
    <td class="text-center">
