...
<html>
    ...
    <body style="padding-top: 10px;font-family: tahoma;">
        <table cellspacing="0" style="width: 30%; margin-right: 5px; float: right;  border: 1px dashed black " dir="rtl">
            <tr>
                <td class="text-center" style="padding: 5px; text-align: right;font-weight: bold;"> كود العميل
            ...
            <tr>
                <td class="text-center" style="padding: 5px; text-align: right;font-weight: bold;"> حالة الفاتورة
                    <span style="margin-right: 10px;">/ @if ($data['is_approved'] == 1)
                            معتمدة
                        @else
                            غير معتمدة
                        @endif
        ...
        <table style="width: 30%;float: right;  margin-right: 5px;" dir="rtl">
            <tr>
                <td class="text-center" style="text-align: center;padding: 5px;">
                    <span style="
                        ...
                        border: 1px solid black; border-radius: 15px;font-weight: bold;"
                    >
                        فاتورة مبيعات
                    </span>
                </td>
            ...
            <tr>
                <td class="text-center" style="text-align: center;padding: 5px;font-weight: bold;">
                    <span style="
                        display: inline-block;
                        width: 200px;
                        height: 30px;
