              ...
              @foreach ($data as $info)
                  <tr>
                      ...
                      <td>
                          ...
                          <span style="color: brown;"> الكمية بالمخزن الحالي <br>{{ $info->quantity_befor_move_store }}
                          </span>
                      ...
                      <td>
                          ...
                          <span style="color: brown;"> الكمية بالمخزن الحالي <br>{{ $info->quantity_after_move_store }}
                          </span>
