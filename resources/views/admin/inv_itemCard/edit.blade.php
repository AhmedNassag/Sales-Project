                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="barcode" id="barcode" class="form-control"
                                value="{{ old('name', $data['barcode']) }}" placeholder="ادخل  باركود الصنف">
                            @error('barcode')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select @if ($counterUsedBefore > 0) disabled @endif name="item_type" id="item_type"
                                ...
                                <option {{ old('item_type', $data['item_type']) == 2 ? 'selected' : '' }} value="2">
                            ...
                            <select name="inv_itemcard_categories_id" id="inv_itemcard_categories_id" class="form-control ">
                                ...
                                @if (@isset($inv_itemcard_categories) && !@empty($inv_itemcard_categories))
                                    @foreach ($inv_itemcard_categories as $info)
                                        <option
                                            {{ old('inv_itemcard_categories_id', $data['inv_itemcard_categories_id']) == $info->id ? 'selected' : '' }}
                            ...
                            <select name="parent_inv_itemcard_id" id="parent_inv_itemcard_id" class="form-control ">
                                ...
                                @if (@isset($item_card_data) && !@empty($item_card_data))
                                    @foreach ($item_card_data as $info)
                                        <option
                                            {{ old('parent_inv_itemcard_id', $data['parent_inv_itemcard_id']) == $info->id ? 'selected' : '' }}
                                            value="{{ $info->id }}"> {{ $info->name }} </option>
                                    @endforeach
                                @endif
                            </select>
                            ...
                            <select @if ($counterUsedBefore > 0) disabled @endif name="retail_uom_id"
                                ...
                                @if (@isset($inv_uoms_child) && !@empty($inv_uoms_child))
                                    @foreach ($inv_uoms_child as $info)
                                        <option
                                            {{ old('retail_uom_id', $data['retail_uom_id']) == $info->id ? 'selected' : '' }}
                                            value="{{ $info->id }}"> {{ $info->name }} </option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="col-md-6 relatied_parent_counter ">
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="price" id="price"
                                class="form-control" value="{{ old('price', $data['price'] * 1) }}" placeholder="ادخل السعر ">
                            @error('price')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 relatied_parent_counter ">
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="nos_gomla_price"
                                ...
                                value="{{ old('nos_gomla_price', $data['nos_gomla_price'] * 1) }}"
                    ...
                    <div class="col-md-6 relatied_parent_counter ">
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="gomla_price"
                                id="gomla_price" class="form-control"
                                value="{{ old('gomla_price', $data['gomla_price'] * 1) }}" placeholder="ادخل السعر ">
                            @error('gomla_price')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 relatied_parent_counter ">
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="cost_price"
                                id="cost_price" class="form-control"
                                value="{{ old('cost_price', $data['cost_price'] * 1) }}" placeholder="ادخل السعر ">
                            @error('cost_price')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 relatied_retial_counter "
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="price_retail"
                                ...
                                value="{{ old('price_retail', $data['price_retail'] * 1) }}" placeholder="ادخل السعر ">
                            @error('price_retail')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 relatied_retial_counter "
                        ...
                        <div class="form-group">
                            ...
                            <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="nos_gomla_price_retail"
                                ...
                                value="{{ old('nos_gomla_price_retail', $data['nos_gomla_price_retail'] * 1) }}"
                                placeholder="ادخل السعر ">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="has_fixced_price" id="has_fixced_price" class="form-control">
                                <option value="">اختر الحالة</option>
                                <option {{ old('has_fixced_price', $data['has_fixced_price']) == 1 ? 'selected' : '' }}
                                    value="1"> نعم ثابت ولايتغير بالفواتير</option>
                                <option {{ old('has_fixced_price', $data['has_fixced_price']) == 0 ? 'selected' : '' }}
                                    value="0"> لا وقابل للتغير بالفواتير</option>
                            </select>
                    ...
                    <div class="col-md-6" style="border:solid 5px #000 ; margin:10px;">
                        <div class="form-group">
                            ...
                            <div class="image">
                                <img id="uploadedimg" class="custom_img"
                                    src="{{ asset('assets/admin/uploads') . '/' . $data['photo'] }}" alt="لوجو الصنف">
