    ...
    <div class="row">
        ...
        <div class="col-md-3  " id="unit_cost_priceDiv">
            <div class="form-group">
                ...
                <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" name="unit_cost_price"
                    id="unit_cost_price" class="form-control" value="">
            </div>
        </div>
        ...
        <div class="col-md-3  " <div class="form-group " style="text-align: right">
