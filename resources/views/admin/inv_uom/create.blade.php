                    ...
                    <form action="{{ route('admin.uoms.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" id="name" class="form-control" value="{{ old('name') }}"
                                placeholder="ادخل اسم الوحدة" oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')"
                        ...
                        <div class="form-group">
                            ...
                            <select name="is_master" id="is_master" class="form-control">
                                ...
                                <option @if (old('is_master') == 1) selected="selected" @endif value="1"> وحدة اب
                                </option>
                                <option @if (old('is_master') == 0 and old('is_master') != '') selected="selected" @endif value="0"> وحدة
                                    تجزئة</option>
                            </select>
                            @error('is_master')
                                <span class="text-danger">{{ $message }}</span>
