            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="production_lines_code_search" id="production_lines_code_search"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($info->is_approved == 0)
                                                    <a href="{{ route('admin.inv_production_exchange.edit', $info->id) }}"
                                                        class="btn btn-sm  btn-primary">تعديل</a>
                                                    <a href="{{ route('admin.inv_production_exchange.delete', $info->id) }}"
                                                        class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                                                @endif
                                                <a href="{{ route('admin.inv_production_exchange.show', $info->id) }}"
                                                    class="btn btn-sm   btn-info">التفاصيل</a>
                                                <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white"
                                                    target="_blank"
                                                    href="{{ route('admin.inv_production_exchange.printsaleswina4', [$info->id, 'A4']) }}"
                                                    class="btn btn-primary btn-xs"> WA4</a>
                                                <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white"
                                                    target="_blank"
                                                    href="{{ route('admin.inv_production_exchange.printsaleswina4', [$info->id, 'A6']) }}"
